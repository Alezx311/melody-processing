...
import { _a, _json, _max, _min, _rand } from "./shortcuts"
import {
	A,
	N,
	O,
...
export class Helpers {
	...
	//? Helpers._noteBasic -> Возвращает случайное значение ноты в виде символа (A, B, C, D, E, F, G)
	public static get _noteBasic() {
		return this.el(Defaults.MUSIC_NOTES_BASIC)
	}

	//? Helpers._noteSharp -> Возвращает ноту со знаком альтерации # (..._noteBasic | 'A#', 'C#', 'E#', 'F#', 'G#')
	public static get _noteSharp() {
		return this.el(Defaults.MUSIC_NOTES_SHARP)
	}

	//? Helpers._noteBemole -> Возвращает ноту со знаком альтерации b (..._noteBasic | 'Bb', 'Db', 'Eb', 'Fb', 'Ab')
	public static get _noteBemole() {
		return this.el(Defaults.MUSIC_NOTES_BEMOLE)
	}

	//? Helpers._noteChar -> Возвращает случайное значение ноты в виде символа (A, B, C, D, E, F, G)
	public static get _noteChar() {
		return this.el(Defaults.MUSIC_NOTES)
	}

	//? Helpers._noteCharSharp -> Возвращает _noteBasic + ноты со знаками альтерации # (A, А#)
	public static get _noteCharSharp() {
		return this.el(Defaults.MUSIC_NOTES)
	}

	//? Helpers._instrumentKey -> Возвращает случайное значение ноты в виде строки
	public static get _instrumentKey() {
		return this.el(Defaults.INSTRUMENT_KEYS)
	}

	//? Helpers._instrumentValue -> Возвращает случайное значение ноты в виде строки
	public static get _instrumentValue() {
		return this.el(Defaults.INSTRUMENT_VALUES)
	}

	//? Helpers._instrumentShare -> Возвращает случайное значение ноты в виде строки
	public static get _instrumentShare() {
		return this.el(Defaults.INSTRUMENT_SHARED)
	}

	//? Helpers._instrumentId -> Возвращает случайное значение ноты в виде строки
	public static get _instrumentId() {
		return this.el(Defaults.INSTRUMENT_IDS)
	}

	//? Helpers._instrumentNote -> Возвращает случайное значение ноты в виде строки
	public static get _instrumentNote() {
		return this.el(Defaults.INSTRUMENT_NOTES)
	}

	//? Helpers._instrumentFile -> Возвращает случайное значение ноты в виде строки
	public static get _instrumentFile() {
		return this.el(Defaults.INSTRUMENT_FILES)
	}

	//? Helpers._instrumentFolder -> Возвращает случайное значение ноты в виде строки
	public static get _instrumentFolder() {
		return this.el(Defaults.INSTRUMENT_FOLDERS)
	}

	//? Helpers._blissFile -> Возвращает случайное значение ноты в виде строки
	public static get _blissFile(): tBlissFile {
		return this.el(Defaults.BLISS_FILES)
	}

	//? Helpers._blissWord -> Возвращает случайное значение ноты в виде строки
	public static get _blissWord(): tBlissWord {
		return this.el(Defaults.BLISS_WORDS)
	}

	//? Helpers._blissPath -> Возвращает случайное значение ноты в виде строки
	public static get _blissPath(): tBlissPath {
		return this.el(Defaults.BLISS_PATHS)
	}

	//? Helpers._blissIcon -> Возвращает случайное значение ноты в виде строки
	public static get _blissIcon(): tBlissIcon {
		return this.el(Defaults.BLISS_ICONS)
	}

	//? Helpers._scale -> Возвращает случайное значение ноты в виде строки
	public static get _scale() {
		return this.el(Defaults.MUSIC_SCALES)
	}

	//? Helpers._durationChar -> Возвращает случайное значение ноты в виде строки
	public static get _durationChar() {
		return this.el(Defaults.MUSIC_DURATION_CHARS)
	}

	//? Helpers._duration -> Возвращает случайное значение ноты в виде строки
	public static get _duration() {
		return this.el(Defaults.MUSIC_DURATIONS)
	}

	//? Helpers._intervalChar -> Возвращает случайное значение ноты в виде строки
	public static get _intervalChar() {
		return this.el(Defaults.MUSIC_INTERVAL_CHARS)
	}

	//? Helpers._synth -> Возвращает случайное значение ноты в виде строки
	public static get _synth() {
		return this.el(Defaults.MUSIC_SYNTHS)
	}

	//? Helpers._tuningName -> Возвращает случайное значение ноты в виде строки
	public static get _tuningName() {
		return this.el(Defaults.MUSIC_TUNING_NAMES)
	}

	//? Helpers._tuningValue -> Возвращает случайное значение ноты в виде строки
	public static get _tuningValue() {
		return this.el(Defaults.MUSIC_TUNING_VALUES)
	}

	//? Helpers._colorName -> Возвращает случайное значение ноты в виде строки
	public static get _colorName() {
		return this.el(Defaults.COLOR_NAMES)
	}

	//? Helpers._colorCode -> Возвращает случайное значение ноты в виде строки
	public static get _colorCode() {
		return this.el(Defaults.COLOR_CODES)
	}

	//? Helpers._colorClass -> Возвращает случайное значение ноты в виде строки
	public static get _colorClass() {
		return this.el(Defaults.COLOR_CLASS)
	}

	//? Helpers._values -> Возвращает случайное значение ноты в виде строки
	...
	//? Helpers._styleColorGradient -> Возвращает случайное значение ноты в виде строки
	public static get _styleColorGradient() {
		return `${this._colorCode()} ${this.int(0, 100)}.00%`
	}

	//? Helpers._styleBackgroundGradient -> Возвращает случайное значение ноты в виде строки
	...
	//? Helpers._octave -> Возвращает случайное значение ноты в виде строки
	public static get _octave() {
		return this.octave()
	}

	//? Helpers._note -> Возвращает случайное значение ноты в виде строки
	public static get _note() {
		return this.note()
	}

	//? Helpers._velocity -> Возвращает случайное значение ноты в виде строки
	public static get _velocity() {
		return this.velocity()
	}

	//? Helpers._noteValues -> Возвращает случайное значение ноты в виде строки
	...
	public static examples = () => {
		const values = {
			noteBasic: this._noteBasic,
			noteSharp: this._noteSharp,
			noteBemole: this._noteBemole,
			noteChar: this._noteChar,
			noteCharSharp: this._noteCharSharp,
			instrumentKey: this._instrumentKey,
			instrumentValue: this._instrumentValue,
			instrumentShare: this._instrumentShare,
			instrumentId: this._instrumentId,
			instrumentNote: this._instrumentNote,
			instrumentFile: this._instrumentFile,
			instrumentFolder: this._instrumentFolder,
			blissFile: this._blissFile,
			blissWord: this._blissWord,
			blissPath: this._blissPath,
			blissIcon: this._blissIcon,
			scale: this._scale,
			durationChar: this._durationChar,
			duration: this._duration,
			intervalChar: this._intervalChar,
			...
			colorClass: this._colorClass,
			values: this._values,
			styleColorGradient: this._styleColorGradient,
			styleBackgroundGradient: this._styleBackgroundGradient,
			octave: this._octave,
			note: this._note,
			velocity: this._velocity,
			noteValues: this._noteValues
		}
		return values
	}
}
